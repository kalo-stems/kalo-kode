...
/* Renders the EditStudentInfo page for editing a single document. */
const EditStudentInfo = () => {
  // Get the documentID from the URL field. See imports/ui/layouts/App.jsx for the route containing :_id.
  const { _id } = useParams();
  // console.log('EditStudentInfo', _id);
  // useTracker connects Meteor data to React components. https://guide.meteor.com/react.html#using-withTracker
  const { doc, ready } = useTracker(() => {
    // Get access to Student information documents.
  ...
  // console.log('EditStudentInfo', doc, ready);
  ...
  return ready ? (
    <Container className="py-3">
      <Row className="justify-content-center">
        <Col xs={10}>
          <Col className="text-center"><h2>Edit My Information (Student)</h2></Col>
